...
%
\GT{Peux-tu donner une r\'ef\'erence, ne serait-ce qu'\`a un site Web ou \`a Wikipedia?}
%
%
\GT{Pour les r\'ef\'erences ci-bas, il serait pr\'ef\'erable de mettre
une note en bas de page pour l'URL, parce qu'autrement (en tout cas,
avec le logiciel que j'utilise), on ne voit pas qu'il y a une
r\'ef\'erence! Et je crois qu'on ne les verrait pas dans la version
imprim\'ee du texte, que certains \'evaluateurs pourraient lire ou qui
ira \`a la biblioth\`eque.}
%
