...
\begin{figure}[htbp]
  ...
  \caption{Architecture \GT{\`a compl\'eter!}.}
...
\begin{description}
 ...
 Contient un fichier \og install.xml \fg{} qui d\'efinit la table de base de donn\'ees \`a cr\'eer pour ce module d'extension.
