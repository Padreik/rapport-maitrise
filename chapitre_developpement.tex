...
La classe \texttt{qtype\_essayhelper\_stemmer} comporte plusieurs fonctions prot\'eg\'ees qu'il faudrait tester, car chacune effectue un traitement important \`a la d\'etection de mots cl\'es.
...
La r\'eflexion ne permet pas de modifier un objet \`a l'ex\'ecution, mais permet de consulter son \'etat et ce qu'il contient (variables, constantes, classes h\'erit\'ees, interfaces impl\'ement\'ees, m\'ethodes, etc.).
