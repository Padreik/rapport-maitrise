\chapter{D\'eveloppement du module d'extension \texttt{qtype\_essayhelper}}
...
\section{Structure du code du module d'extension \texttt{qtype\_essayhelper}}
\begin{figure}[htbp]
  \includegraphics[scale=0.7]{images/architecture.png}
  \caption{Structure du code \GT{\`a compl\'eter!}.}
...
\begin{description}
 ...
 \end{itemize}
\end{description}
Dans tous les fichiers, nous avons d\^u adapter un peu le code afin de passer de \og qtype\_essay \fg{} \`a \og qtype\_essayhelper \fg{}.

\section{Les classes du module \texttt{qtype\_essayhelper}}

\begin{figure}[htbp]
  \includegraphics[scale=0.5]{images/class.png}
  \caption{Principales classes associ\'ees au module \texttt{qtype\_essayhelper}.}
  \label{dev-class}
\end{figure}
...
Les tests du module d'extension \og qtype\_essay \fg{} ont \'et\'e conserv\'es et adapt\'es \`a notre nouveau module d'extension.
