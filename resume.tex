...
Ce projet
%
\footnote{Projet de type <<recherche appliqu\'ee>>, tel que d\'ecrit
dans les sections 3.1~b) et 3.2~b) du <<Guide pour le projet de
synth\`ese MGL8710>> de la Ma\^\i trise en g\'enie logiciel.}
%
a consist\'e à développer un module d'extension (\textit{plugin}) Moodle pour aider la correction de textes à développement dans une activité de type questionnaire.
