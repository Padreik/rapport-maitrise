...
Ce projet consiste à développer un module d'extension (\textit{plugin}) Moodle pour aider la correction de textes à développement dans une activité de type questionnaire.
