...
\renewcommand\listcodename{Liste des exemples de code}
\renewcommand\listofcodes{% Pris de memoireuqam1.3.cls
{
...
% Pour la page titre
%%%%%%%%%%%%%%%%%%%%
\title{Développement d'un module d'extension Moodle d'aide à la correction des questions de type \og texte~long \fg{}}
...
\uqamrapport %\uqammemoire %% ou \uqamthese ou \uqamrapport
...
\include{chapitre_introduction_moodle}
\include{chapitre_snowball}
\include{chapitre_test}
\include{chapitre_developpement}
