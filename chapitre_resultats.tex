...
\PG{Am\'eliorations possibles: stemmer->split\_words va s\'eparer le mot aujourd'hui. Si j'ai les mots aimera et aimerait, il va mettre en \'evidence deux fois le mot aimerait.}
