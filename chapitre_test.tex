...
\GT{Ci-haut: pas une bonne fa\c{c}on d'avoir une r\'ef\'erence car on
ne voit pas le lien dans le PDF, en tout cas, moi je ne le vois
pas. Soit tu mets une citation ($\backslash$cite), soit une note en
bas de page ($\backslash$footnote).}
...
Un étudiant qui répond avec l'unité \og 10~KM \fg{} alors que l'enseignant a enregistré la réponse \og 10~km \fg{} aura une erreur.
